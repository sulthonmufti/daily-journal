...
const defaultMoods = [
  ...
  { _id: 'd7', name: 'Tenang' },
  { _id: 'd8', name: 'Senang' },
  { _id: 'd9', name: 'Semangat' },
  { _id: 'd10', name: 'Luar Biasa' },
];
...
const Entries = () => {
  ...
  //gabungkan mood bawaan + mood dari database
  const apiMoods = moodsData?.data || [];
  const allMoods = [...defaultMoods, ...apiMoods];
      ...
      <div className="space-y-6 md:space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-[#e5e7eb]">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            ...
            {/* dropdown filter berdasarkan mood */}
            <select 
              value={selectedMood}
